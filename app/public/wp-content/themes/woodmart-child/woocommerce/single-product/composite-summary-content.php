...
?><div class="summary_elements cp_clearfix" ><?php
		...
		<div class="summary_element summary_element_<?php echo esc_attr( $component_id ); ?> <?php echo esc_attr( $summary_element_class ); ?>" data-item_id="<?php echo esc_attr( $component_id ); ?>">
