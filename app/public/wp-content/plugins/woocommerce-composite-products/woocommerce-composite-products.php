...
class WC_Composite_Products {
	...
	public function initialize_plugin() {
		...
		if ( ! function_exists( 'phpversion' ) || version_compare( phpversion(), '7.0.0', '<' ) ) {
			...
			$notice = sprintf( __( 'Woo Composite Products requires at least PHP <strong>%1$s</strong>. Learn <a href="%2$s">how to update PHP</a>.', 'woocommerce-composite-products' ), '7.0.0', 'https://woocommerce.com/document/how-to-update-your-php-version/' );
			require_once( WC_CP_ABSPATH . 'includes/admin/class-wc-cp-admin-notices.php' );
			WC_CP_Admin_Notices::add_notice( $notice, 'error' );
			return false;
		}
