...
<h2 class="step_title_wrapper component_title <?php echo $is_toggled ? 'component_title_toggled' : ''; ?>">
	...
	// Add button to assist screen-readers.
		...
		?><button class="component_title_button aria_button" aria-label="<?php echo esc_attr( sprintf( __( 'Toggles %s', 'woocommerce-composite-products' ), $title ) ); ?>" aria-expanded="<?php echo $is_toggled ? 'false' : 'true'; ?>"></button><?php
